        ...
        is AppRoute.Detail -> {
            if (policyStore != null) {
                ...
                TargetSettingsScreen(
                    ...
                    onToggleAttentionChecks = targetViewModel::onToggleAttentionChecks,
                    onAttentionCheckCountChange = targetViewModel::onAttentionCheckCountChange,
                    onToggleAttentionCheckRandomCount = targetViewModel::onToggleAttentionCheckRandomCount,
                    onAttentionCheckMinCountChange = targetViewModel::onAttentionCheckMinCountChange,
